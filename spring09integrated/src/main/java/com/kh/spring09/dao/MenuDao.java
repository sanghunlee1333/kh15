...
public class MenuDao {
	...
	public void insert(MenuDto menuDto) {
		...
		Object[] data = { menuDto.getMenuName(), menuDto.getMenuType(), menuDto.getMenuPrice(),
	...
	public boolean update(MenuDto menuDto) {
		...
		Object[] data = { menuDto.getMenuName(), menuDto.getMenuType(), menuDto.getMenuPrice(), menuDto.getMenuEvent(),
				menuDto.getMenuNo() };
	...
	// 검색 항목 설정
	private Map<String, String> columnExamples = Map.of("메뉴명", "menu_name", "메뉴종류", "menu_type", "메뉴가격", "menu_price",
			"행사여부", "menu_event");
