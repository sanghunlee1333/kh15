...
//VO(Value Object), 필요에 의해 만드는 묶음 데이터. DTO는 DB와 똑같아야 한다
@Data
public class PageVO {
	//필드 - 계산에 필요한 코어 데이터
	...
	public boolean isSearch() {
		return this.column != null && keyword != null;
	}
	...
	public boolean isFirstBlock() { //위와 같은 의미
		return getStartBlock() == 1;
	}
	...
	public boolean isLastBlock() {//위와 같은 의미
		return getFinishBlock() == getPageCount();
	}
